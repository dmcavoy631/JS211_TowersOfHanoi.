...
$(document).ready(function()
{
  ...
  $('.Tower').click(function()
  {
    ...
    {
      debugger
      $(tower).append(gamePiece);

      $('.MessageBox').addClass(gamePiece);

      console.log(tower, gamePiece)
      gamePiece = null;

    } else {
      // tower = this.id;
      tower = this.id;
      gamePiece = $(this).children().first().detach();
      console.log("Else " + tower,  gamePiece)
    }
  });

  const isLegal = () =>
  {
    console.log(towerPop,  gamePiece)
